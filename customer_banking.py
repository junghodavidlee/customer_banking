...
def main():
    ...
    print(f"Savings Account: Updated balance after {savings_months} months: ${updated_savings_balance:.2f}")
    ...
    print(f"CD Account: Updated balance after {cd_months} months: ${updated_cd_balance:.2f}")
